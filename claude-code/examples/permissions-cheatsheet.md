...
| `disableArtifact` | Disables web-published Artifact pages |
| `disableBundledSkills` | Disables vendor-shipped bundled skills |
| `disableClaudeAiConnectors` | Disables hosted claude.ai MCP connectors |
