...
| `permissions.blockReadsOutsideWorkingDirectories` | `true` blocks Read, Grep, Glob, and LSP outside the working directories, including in bypassPermissions; a project `false` cannot lift a managed `true` |
