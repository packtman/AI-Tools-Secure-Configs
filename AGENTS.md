...
# Validate deployable config files changed from main plus staged and unstaged edits
...
- `.github/workflows/config-discovery.yml` runs the scheduled upstream-source discovery loop and optional config-maintenance agent.
