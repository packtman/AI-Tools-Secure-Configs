...
- The repository includes GitHub Actions for scheduled config discovery and config syntax validation. There is still no build system or runnable application.
