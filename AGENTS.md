...
There is no build or dev server. Development consists of editing documentation and config files. To validate changes:
...
# Validate deployable config files across the repo
python3 scripts/validate_config_files.py

# Validate changed, staged, and untracked deployable config files
