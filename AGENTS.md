...
```bash
# Validate all deployable config files at once
...
- `.github/workflows/config-discovery.yml` is a scheduled upstream-source watcher that can open config-maintenance PRs.
