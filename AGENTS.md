...
```bash
# Validate all supported config and script syntax
...
- The `.github/workflows/` directory contains scheduled config discovery and config syntax validation workflows.
