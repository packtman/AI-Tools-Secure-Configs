...
8. Validate every edited JSON, JSONC, YAML, TOML, or shell file with `python3 scripts/validate_config_files.py` and any focused commands from `AGENTS.md`.
...
- Run `python3 scripts/validate_config_files.py` before you finish.
