...
8. Validate every edited JSON, YAML, TOML, or shell file with the commands in `AGENTS.md` or `python3 scripts/validate_config_files.py --changed --base origin/main`.
...
- Leave unrelated generated discovery state untouched unless the scanner changed it in the current run.
