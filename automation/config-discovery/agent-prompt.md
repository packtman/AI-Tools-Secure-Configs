...
8. Validate every edited JSON, YAML, TOML, or shell file with `python3 scripts/validate_config_files.py` and `git diff --check`.
...
- Validate, commit, and push changes to the current feature branch.
