...
8. Validate edited deployable config files with `python3 scripts/validate_config_files.py --changed`, plus any targeted commands in `AGENTS.md` that apply.
...
- Run `python3 scripts/validate_config_files.py --changed` before committing.
