...
8. Validate every edited JSON, YAML, TOML, or shell file with the commands in `AGENTS.md`, or run `python3 scripts/validate_config_files.py --changed --base-ref origin/main`.
