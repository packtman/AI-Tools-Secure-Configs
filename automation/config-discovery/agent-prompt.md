...
8. Validate every edited JSON, YAML, TOML, or shell file with `python3 automation/config-discovery/validate_repo_configs.py`.
...
- Run `python3 automation/config-discovery/validate_repo_configs.py` before committing.
