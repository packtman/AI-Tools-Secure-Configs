...
8. Validate every edited JSON, YAML, TOML, or shell file with `python3 scripts/validate_config_files.py --changed`, plus the targeted commands in `AGENTS.md` when useful.
