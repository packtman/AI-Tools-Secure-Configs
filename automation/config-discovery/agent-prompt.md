...
8. Validate every edited JSON, YAML, TOML, or shell file with `python3 scripts/validate_config_files.py --all` and any narrower commands in `AGENTS.md`.
...
- Validate with `python3 scripts/validate_config_files.py --all` before committing.
