...
8. Validate every edited JSON, YAML, TOML, or shell file with `python3 scripts/validate_config_files.py --changed origin/main...HEAD` or the file-specific commands in `AGENTS.md`.
...
- Do not edit unrelated tools just because they appear in the full discovery report. Use `reports/agent-scope.md` as the work list for the current run.
