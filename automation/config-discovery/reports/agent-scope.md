...
## Tools to process (4 of 8 with missing terms)
...
- Source: Run Modes and sandbox documentation
- Missing terms: `CURSOR_SANDBOX`, `CURSOR_SANDBOX_LANDLOCK_STATUS`, `fully_enforced`, `sandbox-exec`
