...
- Source: Managed settings documentation
  - Upstream URL: https://docs.anthropic.com/en/docs/claude-code/settings
...
- Source: Hooks documentation
  - Upstream URL: https://docs.anthropic.com/en/docs/claude-code/hooks
  - Missing terms: `ANTHROPIC_MODEL`, `CLAUDE_MODEL`

### Continue.dev

- Source: Configuration reference
  - Upstream URL: https://docs.continue.dev/reference
  - Missing terms: `mcpServers`

### Claude Desktop

- Source: Claude Desktop MCP documentation
  - Upstream URL: https://docs.anthropic.com/en/docs/claude-code/mcp
  - Missing terms: `CLAUDE_CODE_MCP_SERVER_NAME`, `CLAUDE_CODE_MCP_SERVER_URL`

### OpenAI Platform

- Source: OpenAI OpenAPI schema
  - Upstream URL: https://raw.githubusercontent.com/openai/openai-openapi/master/openapi.yaml
