...
| Codex CLI | OpenAI Codex repository | source-removed-from-registry | 200 | https://github.com/openai/codex |
...
> ... ervers MCP allowlist enforcement applies to both remote and local MCP servers. When "Registry
only" is configured, local servers must be included in your registry with the correct server ID,
which must exactly match the installed server ID. A server's canonical ID is often defined in its
documentation or manifest. ## Policy resolution for users with multiple seats MC ...
...
"sha256:4f6236f6efd0dac8cdc9eef5007852bb342d623a6648bea13aa41b1639639e4f",         "label": "",
"name": "codex-windows-sandbox-setup",         "size": 1389,         "state": "uploaded"       },
{         "content_type": "application/x-msdos-program",         "digest":
"sha256:e321035625d4373a8f5d3c5 ...
...
- Change type: `source-removed-from-registry`
- Source URL: https://github.com/openai/codex
- Status: `200`
- Related repo paths: codex-cli/
